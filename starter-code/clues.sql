...
SELECT countrycode FROM countrylanguageWHERE language='Italian' AND percentage=100.00;
--SMR -> San Marino
...
-- Brazil (didn't need to query that i mean come on)
...
-- 221
SELECT name FROM city where id=221;
-- Nova Iguai?alsdkj
...
SELECT name FROM city WHERE city WHERE population=91084;
-- Santa Monica
